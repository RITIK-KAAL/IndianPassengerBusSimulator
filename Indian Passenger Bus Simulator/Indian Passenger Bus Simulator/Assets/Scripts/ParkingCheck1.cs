...
{
    public class ParkingCheck1 : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private GameObject LevelAnalyzer5;
        [SerializeField]
        private GameObject LevelAnalyzer6;
        [SerializeField]
        ...
        private void OnTriggerStay(Collider collider)
        {
            if (collider.gameObject.tag == "PickupPassengers" && instance.CurrentSpeed < 5f)
            {
                ...
                if (CurrentSceneIndex == 21 || CurrentSceneIndex == 25)
                {
                    if (FppCamera.gameObject.activeSelf)
                    {
                        isFpp = true;
            ...
            if (collider.gameObject.tag == "PickupPassengers1" && instance.CurrentSpeed < 5f)
            {
                if (FppCamera.gameObject.activeSelf)
                {
                    isFpp = true;
        ...
        private IEnumerator WaitTime2()
        {
            ...
            {
                Bus.position = BusHolder2.position;
                Bus.rotation = BusHolder2.localRotation;
            }*/
